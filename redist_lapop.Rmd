...
```{r echo=TRUE, message=FALSE, warning=FALSE}
lp08 <- read_dta("/Users/JoseConejeros/Desktop/Asistente Fondecyt/Trabajo/Bases/2008.dta")
lp10 <- read_dta("/Users/JoseConejeros/Desktop/Asistente Fondecyt/Trabajo/Bases/2010.dta")
lp12 <- read_dta("/Users/JoseConejeros/Desktop/Asistente Fondecyt/Trabajo/Bases/2012.dta")
lp14 <- read_dta("/Users/JoseConejeros/Desktop/Asistente Fondecyt/Trabajo/Bases/2014.dta")
...
```{r echo=TRUE, message=FALSE, warning=FALSE}
#Revisamos los primeros 10 casos
head (lp08)
head (lp10)
head (lp12)
head (lp14)
